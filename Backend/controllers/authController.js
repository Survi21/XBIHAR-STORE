...
// // ✅ LOGIN (FIXED: Now sends OTP to registered users)
...
//     // 2. Generate a fresh 6-digit OTP for this login attempt
//     const otp = Math.floor(100000 + Math.random() * 900000).toString();

//     // 3. Save the new OTP and Expiry inside Database
//     user.otp = otp;
//     user.otpExpiry = Date.now() + 5 * 60 * 1000; // 5 minutes validity
//     user.isVerified = false; // Reset verification status until they type correct OTP
//     await user.save();
...
//     // 6. Response to Frontend to show OTP Input screen
//     res.json({
//       success: true,
...
//         name,
//         email,
//         isVerified: true, // ✅ IMPORTANT (OTP skip)
//       });
//     }
