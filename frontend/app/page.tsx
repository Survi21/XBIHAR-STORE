...
//   if (!isLaunched) {
//     return (
//       <main className="relative min-h-screen w-full bg-black text-white overflow-hidden flex flex-col items-center justify-center font-sans selection:bg-red-600 selection:text-white py-12">
...
//           </video>
//           {/* Futuristic Overlay Texture with Deep Base Contrast */}
...
//           {/* 2. PREMIUM CALENDAR METADATA BANNER (Exactly as Image) */}
//           <div className="mb-8 select-none">
//             <p className="font-orbitron text-l md:text-l tracking-[0.4em] text-zinc-100 uppercase inline-flex items-center gap-3">
//               24 July 2026 <span className="text-red-500 text-base scale-150 relative -top-[1px]">•</span> 05:00 PM IST
//             </p>
//           </div>

//           {/* Elegant Tech Core Diamond Separator */}
//           <div className="relative w-28 h-[1px] bg-gradient-to-r from-transparent via-zinc-700 to-transparent mb-6">
//             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1 h-1 bg-zinc-500 rotate-45"></div>
//           </div>

//           {/* Slogan Label */}
//           <h3 className="font-orbitron text-[9px] md:text-[9px] tracking-[0.5em] uppercase text-zinc-400 mb-8 font-medium select-none">
//             The Wait Ends In
//           </h3>

//           {/* 3. SCI-FI DASHBOARD DIGITAL TIMER SYSTEM */}
//           <div className="mb-12 flex items-center justify-center gap-4 md:gap-8 select-none max-w-xl w-full">
            
//             {/* Days Block */}
//             <div className="flex flex-col items-center min-w-[50px] md:min-w-[70px]">
//               <span className="font-orbitron text-xl md:text-xl font-light tracking-wider text-zinc-100">
//                 {timeLeft.days.toString().padStart(2, '0')}
//               </span>
//               <span className="font-orbitron text-[8px] md:text-[9px] tracking-[0.3em] uppercase text-zinc-500 mt-3 font-medium">
//                 Days
//               </span>
//             </div>

//             <span className="text-zinc-700 text-2xl md:text-4xl font-extralight opacity-60 relative -top-3">|</span>

//             {/* Hours Block */}
//             <div className="flex flex-col items-center min-w-[50px] md:min-w-[70px]">
//               <span className="font-orbitron text-3xl md:text-5xl font-light tracking-wider text-zinc-100">
...
//             {/* Seconds Block */}
//             <div className="flex flex-col items-center min-w-[50px] md:min-w-[70px]">
//               <span className="font-orbitron text-xl md:text-xl font-light tracking-wider text-white">
...
//           {/* Lower Tech Core Diamond Separator */}
//           <div className="relative w-28 h-[1px] bg-gradient-to-r from-transparent via-zinc-700 to-transparent mb-10">
//             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1 h-1 bg-zinc-500 rotate-45"></div>
//           </div>

//           {/* 4. EXACT CUSTOM "GET NOTIFIED" HUD TRIGGER BUTTON */}
//           <button 
//             onClick={() => setIsModalOpen(true)}
//             className="relative px-12 py-3.5 bg-black/40 border border-red-950 text-red-500 hover:text-white hover:border-red-600 text-[10px] tracking-[0.45em] uppercase transition-all duration-500 group overflow-hidden shadow-[0_0_20px_rgba(220,38,38,0.05)] rounded-[2px]"
//           >
//             {/* Smooth Red Glow Slide Transition Effects */}
...
//             <span className="relative z-10 font-orbitron flex items-center justify-center gap-3">
//               Get Notified
//               <span className="font-mono text-xs tracking-normal transform group-hover:translate-x-1 transition-transform duration-300 relative top-[0.5px]">
//                 &gt;
//               </span>
//             </span>
...
//             <div className="relative w-full max-w-[440px] bg-gradient-to-b from-[#111111]/95 to-[#070707]/98 border border-zinc-800/80 px-8 py-10 text-center shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] rounded-[4px]">
              
//               <button 
//                 onClick={() => setIsModalOpen(false)}
//                 className="absolute top-4 right-4 text-zinc-600 hover:text-zinc-300 text-xs font-mono transition-colors"
//               >
//                 ✕
//               </button>

//               <h4 className="text-xl md:text-2xl tracking-[0.25em] font-orbitron text-zinc-100 uppercase mb-4 select-none">
//                 Get Instant Updates
//               </h4>

//               <div className="relative w-36 h-[1px] bg-gradient-to-r from-transparent via-red-600/80 to-transparent mx-auto mb-6">
...
//               <p className="text-sm text-zinc-400 font-light tracking-wide leading-relaxed px-2 mb-8 select-none">
...
//                   className="w-full py-4 bg-transparent hover:bg-zinc-900/30 border border-zinc-800 hover:border-zinc-500 text-zinc-100 text-xs tracking-[0.2em] uppercase transition-all duration-300 flex items-center justify-between px-6 group rounded-[4px]"
//                 >
...
//                   target="_blank" 
//                   rel="noopener noreferrer"
//                   className="w-full py-4 bg-gradient-to-b from-red-950/70 via-red-900/60 to-red-950/80 hover:from-red-900/70 hover:to-red-950/90 border border-red-800/40 text-zinc-100 text-xs tracking-[0.2em] uppercase transition-all duration-500 flex items-center justify-between px-6 group rounded-[4px] relative shadow-[0_8px_25px_-6px_rgba(220,38,38,0.25)]"
//                 >
//                   <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-4/5 h-[1px] bg-red-500/40 shadow-[0_-2px_12px_#ef4444]"></span>
